 ...
 * A map of all the ASCII printable characters. Key is the ASCII code for the 
 character. Value is a AwtCharConstruction object containing the details of that 
 ...
 */
     ...
     * @return the map of ASCII codes and their AwtCharConstruction objects
     */
    private static HashMap<Integer, AwtCharConstruction> makeMap() {
...
//        map.put(34, new AwtCharConstruction("\"", KeyEvent.VK_QUOTE, true));
 ...
 which will retrieve AwtCharConstruction information from the correct map.
     */
    public AwtKeyMap() {
 ...
 character, null or other as the designer wishes in the case of no match
     ...
     * empty
     */
    public AwtCharConstruction getCharCon(char c) throws java.lang.NullPointerException {
 ...
 other as the designer wishes in the case of no match
     ...
     * empty
     */
    public AwtCharConstruction getCharCon(int ascii_code) throws java.lang.NullPointerException {
