...
public class AwtRobotTester extends JFrame implements KeyListener, ActionListener {
    ...
    private static void createAndShowGUI() {
        ...
        AwtRobotTester frame = new AwtRobotTester("Robot Map Tester");
    ...
    private AwtRobotTester(String app_title) {
        super(app_title);
...
//        txtInput.setMinimumSize(new Dimension(150,20));
        ...
        btnSubmit = new JButton(AwtRobotTester.BTN_SUBMIT_TEXT);
        btnSubmit.addActionListener(this);        
        btnClear = new JButton(AwtRobotTester.BTN_CLEAR_TEXT);
...
//        System.out.println("button text " + btn.getText());
        ...
        switch (btn.getText()) {
            case AwtRobotTester.BTN_CLEAR_TEXT:                
//                System.out.println("btnClear click");                
                txtOutput.setText("");
                txtInput.setText("");
                txtInput.requestFocusInWindow();
                break;
            case AwtRobotTester.BTN_SUBMIT_TEXT:
                echoChar();
                break;
            default:                
        }
...
//        typist.type((char)txtInput.getText().codePointAt(0));
        typist.type(AwtKeyMap_EN_US.getAsciiNumber(txtInput.getText()));
